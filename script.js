...
function prja3() {
    $(".prj-main3").css("height","55%").css("width","32%").css("cursor","pointer")
    $(".prj7").css("filter","brightness(110%)").css("bottom","3.2vw")
    $(".prj8").css("color","white")
    $(".prj9").css("color","white")
    $(".e4").css("color","rgb(201, 47, 47)")
}
function prjf3() {
    $(".prj-main3").css("height","50%").css("width","30%")
    $(".prj7").css("filter","brightness(30%)").css("bottom","2.4vw").css("filter","blur(1px)")
    $(".prj8").css("color","gray")
    $(".prj9").css("color","gray")
    $(".e4").css("color","rgb(126, 46, 46)")
}
